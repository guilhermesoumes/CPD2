...
def main():
    ...
    def _etapa_01(rap_path: str):
        ...
        tabela = tabela[tabela['DISCIPLINA'].isin(['Estudo de Tráfego', 'Projeto Geométrico', 'Projeto de Pavimentação'])]
    ...
    def principal():
        ...
        perguntas_IA = [
            ...
            "Indicação dos segmentos homogêneos através de estaqueamento dos trechos e georreferenciados?",
