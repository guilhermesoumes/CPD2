...
def main():
    ...
    def _etapa_01(rap_path: str):
        ...
        tabela = tabela[tabela['DISCIPLINA'].isin(['Estudo Geológico', 'Estudo Geotécnico', 'Projeto Geométricoo'])]
    ...
    def principal():
        ...
        perguntas_IA = [
            ...
            "Há a descrição quanto a localização da obra?",
            "No documento foi apresentado investigações geotécnicas que caracterizam solo de fundação?",
            "O documento apresenta as coordenadas de localização da obra?"
            "Foi informado a agressividade do meio ambiente adotada para o projeto?"
        ]
