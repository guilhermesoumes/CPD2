...
class MainApp(ctk.CTk):
    ...
    def campos_lado_esquerdo(self):
        ...
        criar_label(self, "Edital")

        self.nm_processo = ctk.CTkEntry(
            self.frame_esquerdo,
            placeholder_text="Processo de análise"
        )

        self.nm_processo.pack(
            fill="x",
            padx=30,
            pady=(0)
        )
        ...
        self.nm_edital = ctk.CTkEntry(
            self.frame_esquerdo,
            placeholder_text="Edital"
        )
        ...
        criar_label(self, "Contrato")

        self.nm_contrato = ctk.CTkEntry(
            self.frame_esquerdo,
            placeholder_text="Contrato"
        )

        self.nm_contrato.pack(
            fill="x",
            padx=30,
            pady=0
        )
        ...
        criar_label(self, "Modalidade de contratação")

        self.nm_modalidade = ctk.CTkEntry(
            self.frame_esquerdo,
            placeholder_text="Modalidade de contratação"
        )

        self.nm_modalidade.pack(
            fill="x",
            padx=30,
            pady=0
        )
        ...
        criar_label(self, "Rodovia")

        self.nm_BR = ctk.CTkEntry(
            self.frame_esquerdo,
            placeholder_text="BR no formato XXX/UF. Ex: 123/DF"
        )
        ...
        criar_label(self, "Extensão")

        self.nm_extensao = ctk.CTkEntry(
            self.frame_esquerdo,
            placeholder_text="Extensão"
        )

        self.nm_extensao.pack(
            fill="x",
            padx=30,
            pady=0
        )
        ...
        criar_label(self, "Lote")

        self.nm_lote = ctk.CTkEntry(
            self.frame_esquerdo,
            placeholder_text="Lote"
        )
        ...
        criar_label(self, "Tipo de projeto")
        ...
        self.nm_tipo_projeto = ctk.CTkOptionMenu(
            self.frame_esquerdo,
            values=self.tipo_projeto
        )

        self.nm_tipo_projeto.pack(
            fill="x",
            padx=30,
            pady=0
        )
        ...
        self.nm_fase = ctk.CTkOptionMenu(
            self.frame_esquerdo,
            values=self.opcoes_fase
        )
        ...
        criar_label(self, "Versão da análise")

        self.nm_versao = ctk.CTkEntry(
            self.frame_esquerdo,
            placeholder_text="Análise (1ª, 2ª etc.)"
        )
        ...
        criar_label(self, "Número do último relatório")

        self.nm_ult_rel = ctk.CTkEntry(
            self.frame_esquerdo,
            placeholder_text="Número"
        )

        self.nm_ult_rel.pack(
            fill="x",
            padx=30,
            pady=0
        )
        ...
        criar_label(self, "Analista")

        self.nm_analista = ctk.CTkEntry(
            self.frame_esquerdo,
            placeholder_text="Analista"
        )

        self.nm_analista.pack(
            fill="x",
            padx=30,
            pady=0
        )
