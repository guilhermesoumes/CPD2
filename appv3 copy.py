...
class MainApp(ctk.CTk):
    ...
    def campos_lado_esquerdo(self):
        ...
        def criar_entry_linha(texto, placeholder=""):
            frame = ctk.CTkFrame(
                self.frame_esquerdo,
                fg_color="transparent"
            )
        ...
        criar_entry_linha("Edital", "Edital")
        
        # =====================================================
        # CONTRATO
        # =====================================================

        criar_label("Contrato")
        ...
        criar_label("Modalidade de contratação")
        ...
        criar_label("Número do último relatório")
